...
struct  ExtendedKeyUsageExtension_t749  : public X509Extension_t743
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t708 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t749_StaticFields{
	...
	Dictionary_2_t216 * ___U3CU3Ef__switchU24map14_4;
};
